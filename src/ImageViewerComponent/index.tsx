  ...
  return (
    <div>
      <div className='absolute z-10 grid justify-end gap-1 py-2 right-2'>
        <Button className=' bg-slate-800 hover:bg-slate-800 hover:text-white border-none text-white' variant={"outline"} size={"sm"} onClick={zoomIn}>
          <ZoomInIcon />
        </Button>
        <Button  className=' bg-slate-800 hover:bg-slate-800 hover:text-white border-none text-white'  variant={"outline"} size={"sm"} onClick={zoomOut}>
          <ZoomOutIcon />
        </Button>
        <Button className=' bg-slate-800 hover:bg-slate-800 hover:text-white border-none text-white'  variant={"outline"} size={"sm"} onClick={rotateLeft}>
          <Rotate3dIcon />
        </Button>
        <Button className=' bg-slate-800 hover:bg-slate-800 hover:text-white border-none text-white'  variant={"outline"} size={"sm"} onClick={flipImage}>
          <FlipHorizontal2Icon />
        </Button>
        <Button className=' bg-slate-800 hover:bg-slate-800 hover:text-white border-none text-white'  variant={"outline"} size={"sm"} onClick={resetAll}>
          <RotateCcwIcon />
        </Button>
      </div>
      <PanViewer
