...
const RejectModal = (props: Props) => {
    ...
    const isValid = () => {
        if (reason === "OTHERS") {
            if (!customReason) return false
            if (customReason.length < 1) return false
        }
        return true
    }
    return (
        <Dialog open={showRejectModal} onOpenChange={() => handleClose()}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="flex justify-center flex-col">
                    ...
                    </Select>
                    {
                        ...
                        <div className="mt-4 flex flex-col gap-y-2">
                            ...
                            <Input placeholder="reason" onChange={({ target }) => setCustomReason(target.value)} required />
                        </div>
                ...
                <DialogFooter className="mt-3">
                    <Button disabled={isValid() ? false : true} type="button" className="bg-red-800"
